...
void FilterComponent::resized()
{
    ...
    filterSelectorLabel.setBounds(10, 35, 90, labelHeight);
...
void FilterComponent::setSliderWithLabel(juce::Slider& slider, juce::Label& label, juce::AudioProcessorValueTreeState& apvts, juce::String paramId,
